...
loghandler = {
    notparam: {
        ...
        getApikey: 'Apikey?? Chat Gw Gan Free Kok'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, chat gw aja gan gratis kok'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'irieneCans') return res.json(loghandler.invalidKey)
...
router.get('/wikipedia', async (req, res, next) => {
	...
	if(apikeyInput != 'irieneCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api-irienee.herokuapp.com/api/wiki?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/randomquote/muslim', async (req, res, next) => {
	...
	if(apikeyInput != 'irieneCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api-irienee.herokuapp.com/api/quote?type=agamis`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/random/meme', async (req, res, next) => {
	...
	if(apikeyInput != 'irieneCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api-irienee.herokuapp.com/api/meme`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/quotes/kanye', async (req, res, next) => {
	...
	if(apikeyInput != 'irieneCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api-irienee.herokuapp.com/api/quote?type=kanye`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/anime/kusonime', async (req, res, next) => {
	...
	if(apikeyInput != 'irieneCans') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://api-irienee.herokuapp.com/api/kusonime?search=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/gabut', async (req, res, next) => {
	...
	if(apikeyInput != 'irieneCans') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://api-irienee.herokuapp.com/api/bosan`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/manga', async (req, res, next) => {
	...
	if(apikeyInput != 'irieneCans') return res.json(loghandler.invalidKey)
	if(!search) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter search"})
       fetch(encodeURI(`https://api-irienee.herokuapp.com/api/manga?keyword=${search}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
